...
#   1.2 Если несколько таблиц, проверить что они совпадают
#   1.3 С доп.опциями проверять наличие потерянных файлов, пересекающихся цепочек и неверных размеров файлов
#   1.4 Сделать исправление ошибок ^^^
# 2. Возможность просмотра файлов (text, hex)
# 3. dir /b, /s
# 4. Возможность копирования файлов и каталогов на хостовую машину (с указанием места назначения)
